...
<form method="post" class="form-horizontal" action="/news" enctype='multipart/form-data'>
    @csrf
    <div class="form-group" style="margin-top:20px;"><label class="col-sm-2 control-label">Main Title</label>
        <div class="col-sm-10"><input type="text" class="form-control" name="main_title" value="{{old('main_title')}}"> 
    ...
    <div class="form-group" style="margin-top:20px;"><label class="col-sm-2 control-label">Sub Title</label>
        <div class="col-sm-10"><input type="text" class="form-control" name="sub_title" value="{{old('sub_title')}}"> 
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Content</label>
        <div class="col-sm-10"><textarea style = "height: auto;" type="text" id="content" class="form-control" name="content" >{{old('content')}}</textarea> 
...
<script type='text/javascript'>
    ...
    if (type) {
        $.ajax({
            type: "GET",
            url: "{{ route('ajax.relatedimages.index', 1) }}",
            success: function (res) {
                if (res) {
                    $.each(res, function (key, newsObj) {
                        console.log(newsObj.path);
