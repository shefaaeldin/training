...
<form method="post" class="form-horizontal" action="/profile/{{$profile->id}}">
    ...
    <div class="form-group" style="margin-top:20px;"><label class="col-sm-2 control-label">First name</label>
        <div class="col-sm-10"><input type="text" class="form-control" name="first_name" value="{{old('first_name')? old('first_name') : $profile->user->first_name}}"> 
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Last name</label>
        <div class="col-sm-10"><input type="text" class="form-control" name="last_name" value="{{old('last_name')? old('last_name') : $profile->user->last_name}}"> 
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Email</label>
        <div class="col-sm-10"><input type="email" placeholder="placeholder" class="form-control" name = "email" value="{{old('email')? old('email') : $profile->user->email}}">
            @if ($errors->has('email'))
            <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group"><label class="col-sm-2 control-label">Phone number</label>
        <div class="col-sm-10"><input type="text" class="form-control" name="phone" value="{{old('phone')? old('phone') : $profile->user->phone}}"> 
            @if ($errors->has('phone'))
            <span class="invalid-feedback" role="alert">
    ...
    <div class="form-group" style="margin-top:20px;"><label class="col-sm-2 control-label">Country</label>
        <div class="col-sm-10">   <select name="country" id="country">
                ...
                <option value='{{$country->name->common}}' {{$country->name->common == $profile->country ? "selected" : ""}}>{{ $country->name->common }}</option>
                @endforeach
            </select>
    ...
    <div class="form-group" style="margin-top:20px;"><label class="col-sm-2 control-label">Profile image</label>
        <div class="col-sm-10">
            ...
            @if($profile->photo)
            <img src="{{asset('storage/' . $profile->photo)}}" class="img-circle"  style="max-height: 100px; " />
            @endif
